             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-4xl mx-auto">
              {CHARACTERS.map(char => (
                <div
                  ...
                  className={`bg-white p-5 rounded-3xl border-2 cursor-pointer transition-all duration-300 relative overflow-hidden group ${
                    hoveredChar === char.id ? 'border-blue-400 shadow-xl scale-[1.02]' : 'border-slate-100 shadow-sm'
                  }`}
                >
