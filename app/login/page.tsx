...
import { Mail, Lock, ArrowRight, Loader2, LogIn, ArrowLeft, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row animate-fade-in-up">
        ...
        <div className="md:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-800 p-10 flex flex-col justify-between text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl font-extrabold leading-tight mb-4">
              Chào mừng trở lại! <br /> Sensei AI đang chờ bạn.
            </h2>
            <p className="text-blue-100 text-lg">
              Tiếp tục hành trình chinh phục JLPT và giao tiếp tiếng Nhật trôi chảy ngay hôm nay.
            </p>
          </div>
        ...
        <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-white relative">
          ...
          <div className="mb-8 text-center md:text-left">
            ...
            <p className="text-slate-500">Nhập thông tin tài khoản của bạn để tiếp tục.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              {loading ? <Loader2 className="animate-spin" /> : <><LogIn size={20} /> Đăng Nhập</>}
            </button>
          </form>

          <div className="relative my-8">
            <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-slate-200"></div></div>
            <div className="relative flex justify-center text-sm"><span className="px-2 bg-white text-slate-500">Hoặc tiếp tục với</span></div>
          </div>
          ...
          <p className="mt-8 text-center text-slate-600">
            Chưa có tài khoản?{' '}
            <Link href="/register" className="text-blue-600 font-bold hover:underline flex items-center justify-center gap-1 inline-flex">
